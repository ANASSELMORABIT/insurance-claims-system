        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HolderEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Claims_AspNetUsers_ClientId",
                        column: x => x.ClientId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ClaimStatusHistories_AspNetUsers_ChangedById",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { "admin-user-id-001", 0, "de806de9-bdc3-4e22-8884-854b2dac4a1c", new DateTime(2026, 5, 15, 8, 13, 38, 282, DateTimeKind.Utc).AddTicks(8207), "admin@insurance.com", true, "Admin", true, "System", false, null, "ADMIN@INSURANCE.COM", "ADMIN@INSURANCE.COM", "AQAAAAIAAYagAAAAELtewy3uPe0ARBZoj8CjqXLDfOINI8EcNfuS+pJFYAqOCPdd1k7R2VDrtozKaCBA3w==", null, false, "f1496cf5-c652-47f0-a8d3-92a037d679fc", false, "admin@insurance.com" });
